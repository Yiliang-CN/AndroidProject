...
public class OrderAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.orderShopName.setText(orderBean.get(position).getShopName());
        holder.orderID.setText(String.valueOf(orderBean.get(position).getId()));
        holder.orderContent.setText(orderBean.get(position).getContent());
        holder.orderPrice.setText(String.valueOf(orderBean.get(position).getPrice()));
        holder.orderTime.setText(orderBean.get(position).getTime());
        holder.orderState.setText(orderBean.get(position).getState());
